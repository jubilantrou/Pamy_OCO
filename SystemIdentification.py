...
# %% constant
anchor_ago_list        = [19300,17500,17100,13000] #np.array([17500, 18500, 16000, 15000])
anchor_ant_list        = [19900,22000,16900,13000] #np.array([17500, 18500, 16000, 15000])
...
amp_list               = [2.5] #[3.5,2.5]  # amp_u * 1000
